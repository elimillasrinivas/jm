      ...
      <div className="container">
        <div className="row">
          ...
          <div className="mobile-nav desktop-menu">
            <h2>One Stop Solution Services</h2>
            <p className="des">
            ...
            <figure>
              <img src="/img/construction-1.jpg" alt="image" />
            </figure>

            <h3>Get in touch</h3>
            <p className="num">+91 9951111167, 8977011167</p>
            <p className="adrs">
              Pochamma Temple Rd, B.N Reddy Nagar, Hyderabad, Telangana 500070
            </p>
